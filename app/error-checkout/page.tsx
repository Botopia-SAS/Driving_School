  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white">
      <Suspense fallback={<div className="text-center">Loading...</div>}>
        {/* Puedes mostrar el overlay avanzado aquí si lo necesitas */}
        {/* <CheckoutErrorOverlay open={open} onClose={handleClose} message={cancellationMessage} isProcessing={isProcessingCancellation} /> */}
        {/* O simplemente el cliente de error por ahora: */}
        <ErrorCheckoutClient />
      </Suspense>
    </div>
  );
